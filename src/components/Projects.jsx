...
//     },
//     {
//       title: 'CareerCompass – AI-Powered Job Search & Networking Platform',
//       description:
//         'End-to-end career platform that uses AI to match you with ideal roles, optimize your resume, track applications, and connect you with recruiters.',
//       tech: ['Next.js 15', 'Spring Boot', 'Supabase', 'OpenAI API', 'Elasticsearch'],
//       image:
//         'https://images.pexels.com/photos/3182810/pexels-photo-3182810.jpeg?auto=compress&cs=tinysrgb&w=600',
...
//         <div className="text-center mg-16">
...
//               {project.featured && (
//                 <div
//                   className="absolute top-4 left-4 z-20 bg-gradient-to-r from-[#84ff00] to-[#ffd93d] text-black text-xs font-bold px-3 py-1
...
//                   <button
//                     className="flex-1 bg-gradient-to-r from-[#84ff00] to-[#ffd93d] text-black px-4 py-2 rounded-lg font-semibold
//          hover:shadow-lg hover:shadow-[#84ff00]/20 transition-all duration-300 transform hover:scale-105 flex items-center
...
//                   </button>
//                   <button
//                     className="flex-1 border border-[#8b5cf6] text-[#8b5cf6] px-4 py-2 rounded-lg font-semibold hover:bg-[#8b5cf6]
//          hover:text-white transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 text-sm"
//                   >
//                     <Github size={14} />
//                     GitHub
//                   </button>
...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      image:
        'https://images.pexels.com/photos/3182810/pexels-photo-3182810.jpeg?auto=compress&cs=tinysrgb&w=600',
      liveUrl: '', // Add your live demo URL when available
      repoUrl: '', // Add your GitHub repo URL when available
      color: 'from-yellow-500 to-orange-500',
      featured: false,
      status: 'In Development',
    },
